...
class AuthModule {
    ...
    @Provides
    @Singleton
    fun provideDatabaseRealtimeRepository(): DatabaseFirebaseRealtimeRepository {
        return DatabaseFirebaseRealtimeRepositoryImpl(provideDatabaseRealtimeInstance(), provideAuth())
    }
