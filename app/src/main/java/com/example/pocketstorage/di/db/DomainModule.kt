...
class DomainModule {
    ...
    @Provides
    fun provideDeleteInventoryByIdUseCase(databaseRepository: DatabaseRepository)
    : DeleteInventoryByIdUseCase {
        return DeleteInventoryByIdUseCase(databaseRepository)
    }
    ...
    @Provides
    fun provideDeleteLocationByIdUseCase(databaseRepository: DatabaseRepository)
            : DeleteLocationByIdUseCase {
        return DeleteLocationByIdUseCase(databaseRepository)
    }
    ...
    @Provides
    fun provideTransferInventoryAnotherBuildingUseCase(databaseRepository: DatabaseRepository)
            : TransferInventoryAnotherBuildingUseCase {
        return TransferInventoryAnotherBuildingUseCase(databaseRepository)
    }
}
